...
// Based on Window 10 i2c trace
static const struct ov8856_reg mode_3280x2468_regs[] = {
	{0x3000, 0x00},
	{0x300e, 0x00},
	{0x3010, 0x00},
	{0x3015, 0x84},
...
// Based on Window 10 i2c trace
static const struct ov8856_reg mode_3280x1968_regs[] = {
	{0x3000, 0x00},
	{0x300e, 0x00},
	{0x3010, 0x00},
	{0x3015, 0x84},
...
static const struct ov8856_mode supported_modes[] = {
	...
	},
	{
		...
		.vts_min = 2498,
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_3280x1968_regs),
			.regs = mode_3280x1968_regs,
		},
		.link_freq_index = OV8856_LINK_FREQ_720MBPS,
	},
	{
