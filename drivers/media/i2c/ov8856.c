...
static const struct ov8856_reg mode_3264x2448_regs[] = {
	...
	{0x3d8c, 0x73},
	{0x3d8d, 0xde},
	//// black level calibration (BLC) 4.4
	// BLC CTRL XX <- (reg & 0xff)
	{0x4001, 0xe0},
	{0x4003, 0x40},
	{0x4008, 0x00},
	{0x4009, 0x0b},
...
static int ov8856_get_hwcfg(struct ov8856 *ov8856, struct device *dev)
{
	...
	if (!ep && fwnode->secondary)
		ep = fwnode_graph_get_next_endpoint(fwnode->secondary, NULL);
